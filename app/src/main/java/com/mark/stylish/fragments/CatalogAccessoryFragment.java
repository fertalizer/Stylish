...
import com.mark.stylish.adapters.CatalogAccessoryAdapter;
...
public class CatalogAccessoryFragment extends Fragment {
    private RecyclerView mRecyclerView;
    private CatalogAccessoryAdapter mCatalogAccessoryAdapter;
    private ArrayList<Object> mAccessoryObjectArrayList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_catalog_accessory, container, false);
        mRecyclerView = view.findViewById(R.id.rv_accessory);
        GridLayoutManager layoutManager = new GridLayoutManager(getContext(), 2);
        mRecyclerView.setLayoutManager(layoutManager);

        mCatalogAccessoryAdapter = new CatalogAccessoryAdapter(getContext());
        mRecyclerView.setAdapter(mCatalogAccessoryAdapter);

        mAccessoryObjectArrayList = new ArrayList<>();
        isLoading = false;
        mPage = 0;
        new AccessoryTask().execute();
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                Log.i("Accessory Scroll", "-----------onScrollStateChanged-----------");
                Log.i("Accessory Scroll", "newState: " + newState);
            }
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                Log.i("Accessory Scroll", "-----------onScrolled-----------");
                Log.i("Accessory Scroll", "dx: " + dx);
                Log.i("Accessory Scroll", "dy: " + dy);
                Log.i("Accessory Scroll", "CHECK_SCROLL_UP: " + recyclerView.canScrollVertically(-1));
                Log.i("Accessory Scroll", "CHECK_SCROLL_DOWN: " + recyclerView.canScrollVertically(1));
                ...
                if (!recyclerView.canScrollVertically(1) && !isLoading) {
                    Log.i("Accessory Scroll", "We are at Bottom");
                    Log.i("Accessory Scroll", "isLoading =  " + isLoading);
                    isLoading = true;
                    new AccessoryTask().execute();
                }
            }
    ...
    public class AccessoryTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                Request request = new Request.Builder()
                        .url("https://api.appworks-school.tw/api/1.0/products/accessories?paging=" + mPage)
                        .build();
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                ...
                if (jsonString.contains("next_paging")) {
                    ...
                    Log.d("Accessory", "Paging = " + paging);
                    mPage = Integer.parseInt(paging);
                    Log.d("Accessory", "Paging index = " + mPage);
                } else {
                    isLoading = true;
                }
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    Log.d("Accessory", "Title = " + dataTitle);
                    Log.d("Accessory", "Price = " + dataPrice);
                    Log.d("Accessory", "Price = " + dataMainImage);
                    ...
                    mAccessoryObjectArrayList.add(product);

                    mCatalogAccessoryAdapter.updateAccessoryData(mAccessoryObjectArrayList);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
